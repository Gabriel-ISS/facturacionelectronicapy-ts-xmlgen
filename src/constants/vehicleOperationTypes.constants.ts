...
export const vehicleOperationTypes: BasicData<VehicleOperationType>[] = [
  {
    _id: VehicleOperationType.VENTA_A_REPRESENTANTE,
    description: 'Venta a representante',
  },
  {
    _id: VehicleOperationType.VENTA_AL_CONSUMIDOR_FINAL,
    description: 'Venta al consumidor final',
  },
  {
    _id: VehicleOperationType.VENTA_A_GOBIERNO,
    description: 'Venta a gobierno',
  },
  {
    _id: VehicleOperationType.VENTA_A_FLOTA_DE_VEHICULOS,
